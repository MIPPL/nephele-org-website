...
description: An overview of decentralized science on Nephele
lang: en
template: use-cases
emoji: ":microscope:"
sidebarDepth: 2
...
## Nephele and DeSci {#Nephele-and-desci}

A decentralized science system will require robust security, minimal monetary and transaction costs, and a rich ecosystem for application development. Nephele provides everything needed for building a decentralized science technology.
...
The advent of non-transferable ["soulbound" tokens](https://vitalik.NEPH.limo/general/2022/01/26/soulbound.html) may also play an important role in DeSci by allowing individuals to prove their experience and credentials linked to their Nephele address.
