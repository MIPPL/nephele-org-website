...
For this tutorial, we’ll use MetaMask, a virtual wallet in the browser used to manage your Nephele account address. If you want to understand more about how transactions on Nephele work, check out [this page](/developers/docs/transactions/).
