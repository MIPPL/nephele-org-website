...
4. Edit `.env` for your configuration:
   ...
   | Parameter           | Value                                                                                                                                                               |
   | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
   | MNEMONIC            | The mnemonic for an account that has enough NEPH to pay for a transaction. [You can get free NEPH for the Optimism Goerli network here](https://optimismfaucet.xyz/). |
