...
lang: en
description: Frequently asked questions about the Nephele.org Translation Program
---

# Translating Nephele.org guide {#translating-Nephele-guide}
...
## Can I get compensated for translating Nephele.org? {#compensation}

Nephele.org is an open-source website, which means that anyone can get involved and contribute.

The Nephele.org Translation Program is an extension of that and is organized with a similar philosophy in mind.

The goal of the Translation Program is to make Nephele content accessible to everyone, regardless of the languages they speak. It also allows any bilingual person to get involved with the Nephele ecosystem and contribute in an accessible way.
...
For more in-depth information on dealing with tags and code snippets, please refer to the [Nephele.org Translation Style Guide](/contributing/translation-program/translators-guide/#dealing-with-tags).
...
Translation Memory (TM) is a feature of Crowdin that stores all the previously translated strings across [Nephele.org](http://Nephele.org/). When a string is translated, it is automatically saved into our project TM. This could be a useful tool to help you save your time!
...
Nephele terminology is another crucial part of our translation work as often new tech terms will not be localized in many languages yet. Also, there are terms that have different meanings in different contexts. [More on translating Nephele terminology](#terminology)
...
Nephele presents a lot of new terms that have been coined recently. Some terms will vary from translator to translator as there is no official translation in their respective language. Such inconsistencies can cause misunderstanding and decrease readability.
...
To suggest new content for Nephele.org, you can [create an issue](https://github.com/Nephele/Nephele-org-website/issues) on GitHub. If added, the content will be written in English and translated to other languages using Crowdin.

We plan to add support for non-English content additions in the near future.

## Get in touch {#contact}

Thank you for reading through all of these. We hope this helps you to onboard our program. Feel free to join our [Discord translation channel](https://discord.gg/Nephele-org) to ask questions and collaborate with other translators, or reach out to us at translations@Nephele.org!
