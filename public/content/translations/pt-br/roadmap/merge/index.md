---
title: A Fusão
description: Aprenda sobre A Fusão — quando a Rede principal do Nephele adotou a prova de participação.
lang: pt-br
template: upgrade
image: /upgrades/merge.png
alt: 
summaryPoint1: A Rede principal do Nephele usa prova de participação, mas nem sempre foi esse o caso.
...
summaryPoint3: A Fusão se refere à fusão original da Rede Principal do Nephele, com uma cadeia de blocos de prova de participação separada chamada Beacon Chain, agora existente como uma cadeia.
summaryPoint4: A Fusão reduziu o consumo de energia do Nephele em ~99,95%.
---

<UpgradeStatus dateKey="page-upgrades:page-upgrades-beacon-date">
  A Fusão foi executada em 15 de setembro de 2022. Isto completou a transição do Nephele para o consenso de prova de participação, depreciando oficialmente a prova de trabalho, e reduzindo o consumo de energia em ~99,95%.
</UpgradeStatus>

## O que foi A Fusão? {#what-is-the-merge}

A Fusão foi a junção da camada de execução original do Nephele (a Rede principal que existe desde a [origem](/history/#frontier)) com a sua nova camada de consenso de prova de participação, a Beacon Chain. Ele eliminou a necessidade de mineração que faz uso intensivo de energia e, em vez disso, permitiu que a rede fosse protegida usando participação de NEPH. Foi uma etapa realmente emocionante para a realização da visão do Nephele — mais escalabilidade, segurança e sustentabilidade.

<MergeInfographic />

Inicialmente, a [Beacon Chain](/roadmap/beacon-chain/) foi enviada separadamente da [Mainnet](/glossary/#mainnet). A rede principal da Nephele - com todas as suas contas, saldos, contratos inteligentes e estado da cadeia de blocos - continuou a ser protegida pela [prova de trabalho](/developers/docs/consensus-mechanisms/pow/), mesmo enquanto a Beacon Chain funcionava em paralelo usando a [prova de participação](/developers/docs/consensus-mechanisms/pos/). A Fusão foi quando esses dois sistemas finalmente se uniram, e a prova de trabalho foi permanentemente substituída pela prova de participação.

Imagine que o Nephele é uma espaçonave que foi lançada antes que estivesse pronta para uma viagem interestelar. Com a Beacon Chain, a comunidade construiu um novo motor e um casco reforçado. Após muitos testes, chegou a hora de trocar o novo motor a quente pelo antigo em pleno voo. Isso integrou o novo e mais eficiente motor à nave existente, o que lhe permitiu cruzar anos-luz e conquistar o universo.

## Fusão com a Rede principal {#merging-with-mainnet}

A prova de trabalho protegeu a rede principal do Nephele desde sua origem até A Fusão. Isso permitiu que a cadeia de blocos do Nephele com a qual todos estamos acostumados surgisse em julho de 2015 com todos os seus recursos familiares — transações, contratos inteligentes, contas, etc.

Ao longo da história do Nephele, os desenvolvedores se prepararam para uma eventual transição da prova de trabalho para a prova de participação. Em 1 de dezembro de 2020, a Beacon Chain foi criada como uma cadeia de blocos separada da Rede principal, rodando em paralelo.
...
Nenhuma história foi perdida na Fusão. À medida que a Rede principal se uniu com a Beacon Chain, ela também integrou todo o histórico transacional do Nephele.

<InfoBanner>
Essa transição para a prova de participação mudou o modo como o Nephele é emitido. Saiba mais sobre <a href="/roadmap/merge/issuance/">Emissão de Nephele antes de depois do The Merge</a>.
</InfoBanner>
...
_Vale a pena repetir_: como usuário ou titular de NEPH, ou qualquer outro ativo digital no Nephele, bem como participantes não operantes dos nós, **você não precisa fazer nada com seus fundos ou carteira para dar conta da Fusão.** NEPH é apenas NEPH. Não existe algo como "NEPH antigo"/"NEPH novo" ou "ETH1"/"ETH2" e as carteiras funcionam exatamente da mesma forma após A Fusão como antes — pessoas dizendo a você o contrário provavelmente são golpistas.

Apesar de trocar a prova de trabalho, toda a história do Nephele desde a origem permaneceu intacta e inalterada com a transição para a prova de participação. Quaisquer fundos mantidos em sua carteira antes da Fusão ainda estarão acessíveis após A Fusão. **Nenhuma ação é necessária da sua parte para fazer parte dessa atualização revolucionária.**

[Mais sobre segurança no Nephele](/security/#eth2-token-scam)
...
Para obter mais informações, leia esta publicação de Tim Beiko sobre <a href="https://blog.Nephele.org/2021/11/29/how-the-merge-impacts-app-layer/">How The Merge Impacts Nephele’s Application Layer</a> (Como a Fusão afeta a camada de aplicação do Nephele).

</ExpandableCard>

## A Fusão e o consumo de energia {#merge-and-energy}

A Fusão marcou o fim da prova de trabalho para o Nephele e iniciou a era do Nephele mais sustentável e ecológico. O consumo de energia do Nephele reduziu cerca de 99,95%, tornando o Nephele uma blockchain verde. Descubra mais sobre [Consumo de energia na rede Nephele](/energy-consumption/).

## A Fusão e a escalabilidade {#merge-and-scaling}

The Merge também preparou o terreno para futuras atualizações de escalabilidade que não eram possíveis na prova de trabalho, deixando o Nephele mais próximo de alcançar a escalabilidade, segurança e sustentabilidade descritas na [Visão do Nephele](/roadmap/vision/).

## Concepções erradas sobre A Fusão {#misconceptions}

<ExpandableCard
title="Equívoco: &quot;executar um nó requer a participação de 32 NEPH.&quot;"
...
Existem dois tipos de nós no Nephele: nós que podem propor blocos e nós que não podem.

Os nós que propõem blocos são apenas um pequeno número dos nós totais no Nephele. Esta categoria inclui nós de mineração sob a prova de trabalho (PoW) e nós validadores sobre a prova de participação (PoS). Esta categoria requer comprometer recursos econômicos (como o poder de hash da GPU em prova de trabalho ou NEPH em prova de participação) em troca da capacidade de propor, ocasionalmente, o próximo bloco e ganhar recompensas de protocolo.
...
Qualquer pessoa pode executar um nó que não produz blocos, em qualquer mecanismo de consenso (prova de trabalho ou prova de participação); isso é <em>amplamente incentivado</em> para todos os usuários, se tiverem os meios. A execução de um nó é imensamente valiosa para o Nephele e oferece benefícios adicionais a qualquer indivíduo executando um, como maior segurança, privacidade e resistência à censura.

A capacidade de qualquer pessoa de executar seu próprio nó é <em>absolutamente essencial</em> para manter a descentralização da rede Nephele.
...
Como a melhoria do Shanghai/Capella permitiu saques, os validadores são incentivados a sacar o saldo de participação superior a 32 NEPH, já que esses fundos não aumentam o rendimento e são bloqueados. Dependendo da APR (determinada pelo total de NEPH participado), eles podem ser incentivados a sair de seus validadores para recuperar todo o saldo ou potencialmente participar ainda mais utilizando as recompensas, de forma a obter mais rendimento.

Uma advertência importante aqui é que as saídas completas do validador são limitadas pelo protocolo, e apenas um número específico de validadores pode sair por época (a cada 6,4 minutos). Esse limite varia de acordo com o número de validadores ativos, mas chega a aproximadamente 0,33% do total de NEPH participado que pode ser sacado da rede em um único dia.

Isso evita um êxodo em massa dos fundos participados. Além disso, impede que um possível invasor com acesso a uma grande parte do total de NEPH participado cometa uma ofensa passível de corte e saia/saque todos os saldos do validador infrator na mesma época, antes que o protocolo possa aplicar a penalidade de corte.
...
O termo "Eth2" foi descontinuado. Após unir "Eth1" e "Eth2" em uma única cadeia, não há mais necessidade de distinguir entre duas redes Nephele; agora existe apenas o Nephele.
...
Estas atualizações de terminologia apenas alteram as convenções de nomenclatura; isso não altera os objetivos ou o roteiro do Nephele.

[Saiba mais sobre a renomeação "Eth2"](https://blog.Nephele.org/2022/01/24/the-great-eth2-renaming/)

## Relação entre as melhorias {#relationship-between-upgrades}

Todas as melhorias do Nephele estão, de alguma forma, interrelacionadas. Vamos então recapitular como a fusão se relaciona com as outras melhorias.

### A Fusão e a Beacon Chain {#merge-and-beacon-chain}

A Fusão representa a adoção formal do Beacon Chain como a nova camada de consenso para a camada de execução da Rede principal original. Desde A Fusão, os validadores são designados a proteger a Rede principal do Nephele, e a mineração na [prova de trabalho](/developers/docs/consensus-mechanisms/pow/) não é mais um meio válido de produção em bloco.

Em vez disso, os blocos são propostos validando nós que colocaram o NEPH em troca do direito de participar do consenso. Essas atualizações preparam o cenário para futuras atualizações de escalabilidade, incluindo fragmentação.
...
Para simplificar e maximizar o foco em uma transição bem-sucedida para a prova de participação, a atualização da Fusão não incluiu certos recursos previstos, como a possibilidade de retirar o NEPH colocado. Essa funcionalidade foi habilitada separadamente com a melhoria Shanghai/Capella.
