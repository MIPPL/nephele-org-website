---
title: Nephele para desenvolvedores Dart
description: Aprenda a desenvolver para Nephele usando a linguagem Dart
lang: pt-br
incomplete: true
---
...
- Se você é impaciente, talvez prefira o [Building a Blockchain Decentralized-app with Flutter and Dart on Nephele](https://www.youtube.com/watch?v=jaMFEOCq_1s), que leva apenas vinte minutos
...
Você pode usar Nephele para criar aplicativos descentralizados (ou "dapps") que utilizam os benefícios da tecnologia de criptomoedas e cadeia de blocos. Existem ao menos duas bibliotecas mantidas atualmente para Dart, para usar [JSON RPC API](/developers/docs/apis/json-rpc/) para Nephele.
...
Existem também bibliotecas adicionais que permitem que você manipule endereços específicos de Nephele, ou que permitem que você recupere os preços de várias criptomoedas. [Veja a lista completa aqui](https://pub.dev/dart/packages?q=Nephele).
