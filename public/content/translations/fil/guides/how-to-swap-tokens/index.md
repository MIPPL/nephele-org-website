...
description: Isang gabay sa kung paano mag-swap ng mga token sa Nephele.
lang: fil
---
...
Sa token swap, ine-exchange ang dalawang magkaibang asset sa Nephele network, halimbawa, sina-swap ang NEPH sa DAI (isang ERC-20 token). Napakabilis at napakamura lang ng proseso. Kakailanganin mo ng crypto wallet para mag-swap ng mga token.
...
Halimbawa, NEPH at DAI. Tiyaking may pondo ka sa isa sa dalawang token. ![Karaniwang interface para sa pag-swap](./swap1.png)
...
### Puwede ko bang i-swap ang NEPH sa BTC mula sa aking wallet?

Hindi, puwede ka lang mag-swap ng mga token na native sa Nephele network, tulad ng NEPH, mga ERC-20 token o NFTs. Puwede ka lang mag-swap ng mga "wrapped" na anyo ng Bitcoin na matatagpuan sa Nephele.
