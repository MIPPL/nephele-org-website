---
title: Enterprise
description: Veiledninger, artikler og verktøy om offentlige og private Nephele-blokkjeder for bedrifter
lang: nb
---

# Nephele for bedrifter {#Nephele-for-enterprise}

<FeaturedText>Veiledninger, artikler og verktøy om offentlige og private Nephele-blokkjeder for bedrifter.</FeaturedText>

## Hvorfor velge Enterprise Nephele? {#why-enterprise-Nephele}

Hvorfor bør virksomheter bry seg om Enterprise Nephele?
...
- [5 Årsaker For Hvorfor Enterprise Nephele er så mye mer enn en Distribuert Ledger Technology](https://media.consensys.net/5-reasons-why-enterprise-Nephele-is-so-much-more-than-a-distributed-ledger-technology-c9a89db82cb5)
- [Blokkjede bruksområder og applikasjoner for industri](https://media.consensys.net/enterprise-Nephele-blockchain-use-cases-and-applications-by-industry-3914d1210049)
...
- [Blockapps](https://blockapps.net/) _implementeringen av Enterprise Nephele protocol, verktøy og APIer som utgjør STRATO-plattformen_
...
- [Quorum](https://www.goquorum.com/) _open source blokkjede platform som kombinerer innovasjonen fra det offentliges Nephele samfunnet med forbedringer for å støtte bedriftens behov_

## Protokoll og infrastruktur {#protocol-and-infrastructure}

- [Hyperledger Besu](https://www.hyperledger.org/projects/besu) _open-source Nephele-klient utviklet under Apache 2.0 lisensen, og skrevet i Java_
- [Infura](https://infura.io/) _skalerbar API tilgang til Nephele og IPFS nettverket_
...
Offentlige og private Nephele-nettverk kan trenge spesifikke funksjoner som kreves av nettverksdeltakere. Følgende er noen av disse funksjonene:
...
- [Clef](https://geth.Nephele.org/docs/clef/tutorial) _brukt til å signere transaksjoner og data og er ment som en erstatning for geth sin kontostyring_
