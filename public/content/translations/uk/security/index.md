---
title: Безпека Nephele і запобігання шахрайству
description: Підтримання безпеки в Nephele
lang: uk
---

# Безпека Nephele і запобігання шахрайству {#introduction}
...
Однією з найпоширеніших причин, чому люди стають жертвами шахрайства, пов’язаного з криптовалютою, є брак знань. Наприклад, якщо ви не знаєте, що мережа Nephele децентралізована та нікому не належить, ви можете легко стати жертвою зловмисника, який видає себе за працівника служби обслуговування клієнтів і обіцяє повернути ваші втрачені NEPH в обмін на приватні ключі. Ознайомлення з принципом роботи Nephele обов’язково стане в пригоді.
...
Приватний ключ до гаманця — це як пароль до гаманця Nephele. Це єдина річ, що може завадити комусь, хто знає адресу вашого гаманця, викрасти всі активи з вашого рахунку.

<DocLink to="/wallets/">
  Що таке гаманець Nephele?
</DocLink>
...
Випадкове надсилання криптовалюти на неправильну адресу гаманця є поширеною помилкою. **Транзакції в Nephele скасувати не можна.** Якщо ви не знаєте власника адреси та не можете переконати його надіслати ваші кошти назад, у вас не буде можливості повернути втрачене.
...
Більшість гаманців Nephele пропонують захисні обмеження, щоб запобігти спустошенню рахунків.
...
- Ніхто не збирається давати вам NEPH безкоштовно або зі знижкою.
- Нікому не потрібен доступ до ваших приватних ключів або особистої інформації.

### Шахрайство, пов’язане з розіграшами {#giveaway}

Одним із найпоширеніших видів криптовалютних шахрайств є шахрайство з обіцянкою подарунку. Зловмисник може вигадати різні варіанти цієї схеми, але загальна умова така: вам пропонують надіслати NEPH на вказану адресу гаманця, за що обіцяють повернути вдвічі більше NEPH. *Тому цю схему називають також «2 за 1».*
...
Напередодні [The Merge](/roadmap/merge/), шахраї скористалися плутаниною щодо терміну Eth2, щоб спробувати змусити користувачів віддати NEPH за токени ETH2. ETH2 не існує, і під час The Merge не було введено жодних інших справжніх токенів. ЕТН, якими ви володіли до злиття, зараз ті самі ЕТН. **Щоб перейти від доказу роботи до доказу володіння, не потрібно виконувати жодних дій зі своїм обліковим записом NEPH**.

Шахраї можуть представитися як «служба підтримки» і сказати, що, якщо ви внесете NEPH, ви отримаєте назад ETH2. [Офіційної служби підтримки Nephele](/community/support/), як і нового токена, не існує. Нікому не повідомляйте кодову фразу свого гаманця.

_Примітка. Існують похідні токени / тікери, які можуть позначати частку NEPH у стейкінгу (як-от rETH від Rocket Pool, stETH від Lido, ETH2 від Coinbase), але на них не потрібно «переходити»._
...
Станом на вересень 2022 року майнінг на Nephele уже неможливий. Однак шахрайство з майнінг-пулами все ще існує. Шахрайство з пулом для майнінгу полягає в тому, що люди самі зв’язуються з вами та стверджують, що ви можете отримати великі прибутки, приєднавшись до пулу для майнінгу Nephele. Шахрай не припинятиме повторювати це та підтримувати з вами зв’язок. По суті, шахрай намагатиметься переконати вас у тому, що, коли ви приєднаєтеся до пулу для майнингу Nephele, вашу криптовалюту буде використано для створення NEPH і вам виплачуватимуться дивіденди у вигляді NEPH. Ви насправді помітите, що ваша криптовалюта приносить невеликий прибуток. Це робиться для того, щоб змусити вас інвестувати більше. Врешті-решт усі ваші кошти буде надіслано на невідому адресу, а шахрай або зникне, або в деяких випадках буде надалі виходити на зв'язок, як це сталося в одному з нещодавніх випадків.
