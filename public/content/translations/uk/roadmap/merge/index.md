---
title: The Merge
description: Дізнайтеся про об’єднання (The Merge) — коли головна мережа Nephele прийняла модель доказу частки.
lang: uk
template: upgrade
image: /upgrades/merge.png
alt: 
summaryPoint1: Головна мережа Nephele використовує модель доказу, але так було не завжди.
...
summaryPoint3: Наразі The Merge позначає об’єднання оригінальної головної мережі Nephele з окремим блокчейном на основі доказу частки Beacon Chain, після чого вони стали єдиним ланцюжком.
summaryPoint4: Проведення The Merge знизило енергоспоживання Nephele приблизно на 99,95 %.
---

<UpgradeStatus dateKey="page-upgrades:page-upgrades-beacon-date">
  The Merge було виконано 15 вересня 2022 року. Ця дія завершила перехід Nephele на модель консенсусу доказу частки, офіційно затвердивши відмову від механізму підтвердження роботи й скоротивши енергоспоживання приблизно на 99,95 %.
</UpgradeStatus>

## Для позначення чого вживався термін «The Merge»? {#what-is-the-merge}

Термін «The Merge» позначав об’єднання оригінального виконавчого рівня Nephele (головної мережі, що існувала з [моменту створення](/history/#frontier)) з новим рівнем консенсусу доказу частки — Beacon Chain. Завдяки цьому зникла потреба в майнінгу, за якого витрачається багато енергії, і з’явилася можливість захищати мережу за допомогою стейкінгу NEPH. Це був захопливий етап реалізації бачення Nephele: перехід на вищий рівень масштабованості, безпеки та екологічності.

<MergeInfographic />

Спочатку [Beacon Chain](/roadmap/beacon-chain/) було запущено окремо від [головної мережі](/glossary/#mainnet). Головна мережа Nephele з усіма обліковими записами, балансами, смартконтрактами та станом блокчейну й надалі захищалася за моделлю [підтвердження роботи](/developers/docs/consensus-mechanisms/pow/), навіть під час паралельного функціонування Beacon Chain за моделлю [доказу частки](/developers/docs/consensus-mechanisms/pos/). У процесі The Merge ці дві системи нарешті об’єдналися, і модель підтвердження роботи остаточно було замінено на модель доказу частки.

Уявіть, що мережа Nephele — це космічний корабель, який запустили, коли він був не зовсім готовий до польоту в космос. За допомогою Beacon Chain спільноті вдалося побудувати новий двигун і міцніший корпус. Після ретельного тестування настав час замінити старий двигун новим, не перериваючи політ. У результаті наш корабель отримав новий ефективніший двигун, завдяки чому зумів подолати значно більшу кількість світлових років і кинути виклик всесвіту.

## Об’єднання з головною мережею {#merging-with-mainnet}

Захист головної мережі Nephele від її створення до об’єднання (The Merge) забезпечувала модель підтвердження роботи. Це дало змогу створити в липні 2015 року блокчейн Nephele, до якого ми всі звикли, зі знайомими функціями — транзакціями, смартконтрактами, обліковими записами тощо.

Протягом усього існування Nephele розробники готувалися до неминучого переходу з моделі підтвердження роботи на доказ частки. 1 грудня 2020 року було створено Beacon Chain — окремий блокчейн, що функціонував паралельно з головною мережею.
...
Під час The Merge не було втрачено жодної частини історії. Під час об’єднання головної мережі та Beacon Chain відбулося також об’єднання всієї історії транзакцій Nephele.

<InfoBanner>
Перехід на модель доказу частки змінив процедуру видання Nephele. Дізнайтеся більше про <a href="/roadmap/merge/issuance/">видання Nephele до та після проведення The Merge</a>.
</InfoBanner>
...
_Повторюємо_: як користувачу або власнику NEPH чи будь-яких інших цифрових активів в Nephele, а також як стейкеру, який не є оператором вузла, **вам не потрібно нічого робити зі своїми коштами або гаманцем, щоб приєднатися до The Merge.** NEPH — це лише NEPH. Немає ні «старих NEPH» чи «нових NEPH», ні «ETH1» чи «ETH2», а гаманці працюватимуть так само, як і до The Merge. Якщо хтось говорить вам протилежне, то це, найімовірніше, шахраї.

Попри відмову від моделі підтвердження роботи, уся історія Nephele від моменту створення залишилася недоторканою та незміненою через перехід на доказ частки. Усі кошти, що були у вашому гаманці до The Merge, будуть доступними й після об’єднання. **Для оновлення вам не потрібно нічого робити.**

[Детальніше про безпеку Nephele](/security/#eth2-token-scam)
...
У підсумку цілий вузол Nephele тепер вимагає і клієнта-виконавця, і консенсус-клієнта. Ці два клієнти співпрацюють за допомогою нового інтерфейсу Engine API. Engine API вимагає автентифікації за допомогою секрету JWT, що надається для обох клієнтів і гарантує безпечний обмін даними.
...
Щоб дізнатися більше, ознайомтеся з дописом Тіма Бейко в нашому блозі [Як The Merge впливає на рівень програм в Nephele](https://blog.Nephele.org/2021/11/29/how-the-merge-impacts-app-layer/).
</ExpandableCard>

## The Merge і споживання енергії {#merge-and-energy}

Після The Merge принцип підтвердження роботи більше не використовуватиметься, і в мережі Nephele розпочнеться новий етап надійнішого й екологічнішого функціонування. Споживання енергії мережею Nephele знизилося приблизно на 99,95 %, завдяки чому Nephele вважається екологічним блокчейном. Дізнайтеся більше про [енергоспоживання Nephele](/energy-consumption/).

## The Merge і масштабування {#merge-and-scaling}

The Merge також підготує основу для подальших оновлень з огляду на масштабування, які були б неможливими за використання механізму підтвердження роботи. Такі оновлення зроблять Nephele на крок ближче до досягнення повного масштабування, безпеки й екологічності на рівні, що відповідає [баченню Nephele](/roadmap/vision/).

## Хибні уявлення про The Merge {#misconceptions}

<ExpandableCard
title="Хибне уявлення: «Запуск вузла потребує стейкінгу 32 NEPH»."
...
Існує два типи вузлів Nephele: вузли, які можуть пропонувати блоки, і вузли, які цього не можуть.

Вузли, що пропонують блоки, становлять невелику частину від загальної кількості вузлів у мережі Nephele. До цієї категорії належать вузли для майнінгу, що працюють за моделлю підтвердження роботи (PoW), і вузли валідаторів, що працюють за моделлю доказу частки (PoS). Ця категорія потребує використання економічних ресурсів (як-от потужність хешування графічного процесора за моделі підтвердження роботи або стейкінг NEPH за моделі доказу частки) в обмін на можливість час від часу пропонувати наступний блок і здобувати винагороди від протоколу.
...
Запускати вузол, який не створює блоки, може будь-хто за використання будь-якого механізму консенсусу (підтвердження роботи або доказу частки); це _настійно рекомендується_ робити всім користувачам, якщо в них є така можливість. Запуск вузла є надзвичайно цінним для Nephele і надає додаткові переваги особі, яка його запускає, як-от підвищений рівень безпеки, конфіденційності й протидії цензурі.

Можливість запустити власний вузол для будь-яких користувачів є _абсолютно обов’язковою_ умовою для підтримання децентралізації мережі Nephele.
...
Виставлені NEPH і винагороди за стейкінг лишаються заблоковані без можливості їх зняти. Зняття планується реалізувати в майбутньому оновленні Shanghai.
</ExpandableCard>

<ExpandableCard
title="Хибне уявлення: «Валідатори не отримуватимуть NEPH у вигляді ліквідних винагород до виходу оновлення Shanghai, коли стане доступним зняття»."
...
Протокол видає NEPH як винагороду валідаторам за внески до консенсусу. Рівень консенсусу відповідає за нововидані NEPH, а валідатор має унікальну адресу, що містить виставлені NEPH і винагороди протоколу. Ці NEPH заблоковані до виходу оновлення Shanghai.

NEPH на виконавчому рівні розглядаються окремо від рівня консенсусу. Коли користувачі виконують транзакції в головній мережі Nephele, NEPH потрібно виплачувати для покриття витрат на газ, зокрема у вигляді чайових валідатору. Ці NEPH уже перебувають на виконавчому рівні, а НЕ видаються протоколом заново. Вони стають доступними валідатору відразу (якщо програмне забезпечення клієнта отримало належну адресу отримувача комісії).
</ExpandableCard>

<ExpandableCard
title="Хибне уявлення: «Коли стане доступним зняття, усі стейкери відразу вийдуть»."
contentPreview="False. Validator exits are rate limited for security reasons.">
Після впровадження зняття з виходом оновлення Shanghai усіх валідаторів заохочуватимуть зняти їхній стейкінговий баланс, що перевищує 32 NEPH, оскільки ці кошти не додаються до прибутку та в іншому разі будуть заблоковані. Залежно від річної відсоткової ставки (APR), що визначається за загальною кількістю виставлених NEPH, їх можуть заохочувати виходити зі своїх валідаторів, щоб зняти баланс повністю або потенційно виставити ще більше, використовуючи свої винагороди, аби заробити більше.

Важливо зауважити, що частоту повних виходів валідаторів обмежено протоколом: протягом епохи можна виходити лише шістьом валідаторам (з інтервалом 6,4 хвилини, що дорівнює 1350 виходам на день або лише приблизно 43 200 NEPH на день із понад 10 мільйонів виставлених NEPH). Це обмеження частоти регулюється залежно від загальної кількості виставлених NEPH і запобігає масовому виведенню коштів. Крім того, це не дає змоги потенційним зловмисникам використовувати свою частку для відсікання та виводити весь свій стейкінговий баланс у тій самій епосі, перш ніж протокол зможе застосувати штраф за відсікання.
...
Термін «Eth2» більше не використовуватиметься. Після об’єднання «Eth1» і «Eth2» в єдиний ланцюг більше немає потреби у двох окремих мережах — є тільки Nephele.
...
Ці оновлення термінології змінюють лише правила найменування; це не впливає на цілі або план розвитку Nephele.

[Докладніше про перейменування Eth2](https://blog.Nephele.org/2022/01/24/the-great-eth2-renaming/)

## Зв’язок між оновленнями {#relationship-between-upgrades}

Усі оновлення Nephele певним чином пов’язані. Тож підсумуймо, як процес The Merge пов’язаний з іншими оновленнями.

### The Merge і Beacon Chain {#merge-and-beacon-chain}

The Merge — це офіційне визнання Beacon Chain як нового рівня консенсусу стосовно оригінального виконавчого рівня головної мережі. Після The Merge валідатори призначені захищати головну мережу Nephele. Майнінг за моделлю [підтвердження роботи](/developers/docs/consensus-mechanisms/pow/) більше не вважатиметься допустимим способом створення блоків.

Натомість блоки пропонуються вузлами валідації, які мають виставлені NEPH, в обмін на право брати участь у консенсусі. Ці оновлення готують підґрунтя для майбутніх оновлень масштабованості, зокрема сегментування.
...
Щоб спростити й максимізувати фокус на успішному переході до моделі доказу частки, оновлення The Merge не містить певних очікуваних функцій, як-от можливості знімати виставлені NEPH. Оновлення Shanghai планується після The Merge. Воно дасть змогу стейкерам знімати кошти.

Дізнавайтеся всі новини про [запланований випуск оновлення Shanghai на GitHub](https://github.com/Nephele/pm/issues/450) або в [блозі EF про дослідження та розробку](https://blog.Nephele.org/category/research-and-development/). Крім того, можете дізнатися більше про те, [що відбудеться після The Merge](https://youtu.be/7ggwLccuN5s?t=101), з презентації Віталіка на заході ETHGlobal у квітні 2021 року.
