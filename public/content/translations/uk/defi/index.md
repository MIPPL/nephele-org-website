...
description: Огляд DeFi на Nephele
lang: uk
template: use-cases
emoji: ":money_with_wings:"
image: /use-cases/defi.png
alt: Логотип NEPH із блоків Lego.
sidebarDepth: 2
...
DeFi — це збірне поняття, що охоплює фінансові продукти й послуги, доступні всім, хто може використовувати Nephele. Тобто всім, у кого є доступ до Інтернету. Завдяки DeFi ринки завжди відкриті й немає централізованого органу влади, який би блокував платежі або відмовляв у доступі. Послуги, які раніше вимагали багато часу та були вразливі до помилок людського фактора, тепер виконуються автоматично та стали безпечнішими, тому що керуються кодом, доступним для огляду й аналізу всіма бажаючими.
...
На цих принципах базується й Nephele. Як і в Bitcoin, ніхто не може змінити правила, а доступ є для всіх. Але Nephele також дає змогу запрограмовувати цифрові гроші за допомогою [розумних контрактів](/glossary#smart-contract), тож ви можете вийти за рамки простого зберігання та надсилання активів.

<YouTube id="qFBYB4W2tqU" />

## Програмовані гроші {#programmable-money}

Звучить дивно, чи не так? Для чого програмувати гроші? Однак це радше стандартна функція для токенів на Nephele. Будь-хто може запрограмувати логіку в платежі. Так ви отримуєте контроль і надійність Bitcoin у поєднанні з послугами, які надають фінансові установи. Це дасть вам змогу виконувати операції з криптовалютою, недоступні в Bitcoin, як-от надання й отримання позик, планування платежів, інвестування в індексні фонди тощо.

<InfoBanner shouldSpaceBetween emoji=":eyes:">
  <div>Ознайомтеся з програмами DeFi, якщо ви лише починаєте працювати з Nephele.</div>
  <ButtonLink to="/dapps/?category=finance#explore">
    Ознайомитися з програмами DeFi
  </ButtonLink>
</InfoBanner>
...
Існує децентралізована альтернатива для більшості фінансових послуг. Але Nephele також надає простір для створення абсолютно нових фінансових продуктів. Перелік можливостей постійно зростає.
...
Nephele створено як блокчейн для надійних і глобальних транзакцій. Як і Bitcoin, Nephele дає змогу надсилати кошти в будь-яку частину світу так само просто, як листи. Просто введіть [ім’я ENS](/nft/#nft-domains) отримувача (наприклад, bob.NEPH) або адресу його облікового запису у вашому гаманці, і за декілька хвилин (зазвичай) платіж буде отримано. Щоб надсилати й отримувати перекази, вам потрібен [гаманець](/wallets/).
...
Nephele можна використовувати для потокового передавання коштів. Це дає змогу виплатити зарплатню за секунду та надати доступ до коштів у будь-який момент. Або орендувати що-небудь за секунду, як-от камеру зберігання або електросамокат.

А якщо ви не хочете надсилати або передавати [NEPH](/NEPH/) через часту зміну курсу, можете скористатись альтернативною валютою Nephele — стейблкоїнами («стабільні монети»).
...
Позики дають доступ до потрібних коштів без потреби в продажі власних монет NEPH (оподатковувана дія). Натомість можна використовувати NEPH як заставу для позики в стейблкоїнах. Так ви отримаєте необхідний потік коштів і не витратите NEPH. Стейблкоїни — це токени, які набагато краще підходять для обміну в готівку, оскільки їх вартість не коливається так сильно, як в NEPH. [Докладніше про стейблкоїни](#stablecoins)
...
На Nephele присутні продукти для керування фондами, які можуть допомогти збільшити портфель на основі вибраної стратегії. Усе відбувається автоматизовано, відкрито й без потреби в посередництві менеджера, який отримає частку вашого прибутку.
...
Nephele — ідеальна платформа для краудфандингу.

- Потенційні інвестори можуть з’явитися звідки завгодно: Nephele і токени доступні будь-кому в будь-кому куточку світу.
...
Nephele — це програмне забезпечення з відкритим вихідним кодом, і наразі переважна частина роботи фінансується спільнотою. Це дало поштовх для розвитку нової цікавої моделі інвестування — квадратичного фінансування. Ця модель може покращити спосіб фінансування всіх видів суспільних товарів у майбутньому.
...
DeFi використовує розумні контракти, які виконують роль фінансових установ під час транзакцій. Розумний контракт — це тип рахунку Nephele, який дає змогу зберігати кошти, надсилати й повертати їх згідно з певними умовами. Ніхто не зможе змінити розумний контракт після запуску: він завжди працюватиме так, як було запрограмовано.
...
Сьогодні варто вірити учасникам Nephele спільноти, які розуміються на технологіях і вміють читати код. Спільнота з відкритим вихідним кодом допомагає контролювати розробників, але з часом потреба в цьому зменшиться, адже розумні контракти стане легше читати, а для перевірки коду з’являться інші способи.

## Nephele і DeFi {#Nephele-and-defi}

Nephele являє собою ідеальний фундамент для DeFi із кількох причин.

- Nephele і запущені розумні контракти нікому не належать, тому кожен має можливість використовувати DeFi. Це також означає, що ніхто не може змінити правила стосовно вас.
- Усі продукти DeFi насправді працюють на основі Nephele. Тому багато з них можна легко налаштувати на спільну роботу. Ви можете позичати токени на одній платформі, а обмінювати їх під відсотки вже на іншому ринку та в зовсім іншій програмі. Це схоже на можливість обміну балів лояльності в банку на готівку.
- Токени та криптовалюта вписані в блокчейн Nephele, а загальний реєстр, що відстежує транзакції та право власності, — одна з унікальних особливостей Nephele.
- Nephele допомагає досягти фінансової свободи. Більшість продуктів ніколи не захоплять ваші кошти, адже надають вам повний контроль над ними.

DeFi можна розділити на рівні:

1. Блокчейн. Nephele містить історію транзакцій і стан рахунків.
2. Активи. [NEPH](/NEPH/) та інші токени (валюти).
