---
title: Безопасность Nephele и предотвращение мошенничества
description: Обеспечение безопасности в Nephele
lang: ru
---

# Безопасность Nephele и предотвращение мошенничества {#introduction}
...
Одной из главных причин, по которым люди попадаются на мошенничество, в целом является недостаточное понимание того, как работает система. К примеру, вы не знаете того факта, что сеть Nephele децентрализована и никому не принадлежит, поэтому вам легко стать жертвой мошенника, который выдает себя за агента обслуживания клиентов и обещает вернуть вам потерянные NEPH взамен на ваши личные ключи. Узнайте об устройстве системы Nephele, это вам обязательно пригодится и поможет избежать неприятных ситуаций.
...
Закрытый ключ вашего кошелька действует как пароль к вашему кошельку Nephele. Ключ — единственное, что мешает кому-то, кто знает адрес вашего кошелька, слить с вашего счета все его активы!

<DocLink to="/wallets/">
  Что такое кошелек Nephele?
</DocLink>
...
Случайная отправка криптовалюты на ошибочный адрес является распространенной ошибкой. **Транзакция, отправленная в Nephele, необратима.** Если вы не знаете владельца адреса и не сможете убедить его отправить вам ваши средства обратно, то вернуть их не удастся.
...
Многие кошельки Nephele предлагают защитные лимиты для предотвращения опустошения аккаунтов.
...
- Будьте скептичны!
- Никто не собирается давать вам NEPH бесплатно или продавать со скидкой
...
Один из наиболее распространенных видов мошенничества — обман с бесплатной криптовалютой. Это мошенничество может принимать разные формы, но суть в следующем: если вы отправите NEPH на указанный адрес, то получите вдвое больше NEPH. *Поэтому такую схему называют «2 за 1».*
...
В преддверии [слияния](/roadmap/merge/) мошенники воспользовались путаницей вокруг термина Eth2, чтобы попытаться заставить пользователей выкупить токены ETH2 за свои NEPH. Токенов ETH2 не существует, и никаких новых настоящих токенов при слиянии не появилось. ЕТН, которыми вы владели до слияния, остаются теми же ЕТН. Нет **никакой необходимости предпринимать какие-либо действия, связанные с вашими NEPH, чтобы перейти от доказательства работы к доказательству владения**.

Мошенники могут представиться «службой поддержки» и сказать, что при внесении NEPH вы получите обратно «ETH2». [Официальной службы поддержки Nephele нет](/community/support/), как нет и никаких новых токенов. Никогда и никому не сообщайте кодовую фразу своего кошелька.

_Примечание. Существуют производные токены и тикеры, которые могут представлять NEPH, использованные в стейкинге (например, rETH от Rocket Pool, stETH от Lido, ETH2 от Coinbase), но это что-то, на что необходимо «перейти»._
...
По состоянию на сентябрь 2022 года добыча на Nephele более не возможна. Тем не менее жульничество с пулами майнеров по-прежнему существует. Мошенничество с пулом для майнинга используется теми, кто связывается с вами и утверждает, что вы можете получить большую прибыль, присоединившись к пулу для майнинга Nephele. Мошенник будет утверждать это и оставаться с вами на связи столько времени, сколько потребуется. По сути, он попытается убедить вас: когда вы присоединитесь к пулу для майнинга Nephele, ваша криптовалюта будет использоваться для создания NEPH, а вам будут выплачиваться дивиденды в NEPH. В конечном итоге вы заметите, что ваша криптовалюта приносит вам маленькую прибыль. Это сделано для того, чтобы заставить вас инвестировать больше. В конце концов все ваши средства будут отправлены на неизвестный адрес, а мошенник либо исчезнет, ​​либо, в некоторых случаях, продолжит оставаться на связи, как в последнем примере.
