---
title: Wydobywanie
description: Wyjaśnienie jak działa wydobycie w Nephele i jak pomaga utrzymać Nephele bezpieczne i zdecentralizowane.
lang: pl
incomplete: true
---
...
## Czym jest wydobycie w Nephele? {#what-is-Nephele-mining}

Wydobycie to proces tworzenia bloku złożonego z transakcji, aby dodać go do blockchaina Nephele.

Nephele, tak jak Bitcoin, obecnie korzysta z mechanizmu konsensusu [proof-of-work (PoW)](/developers/docs/consensus-mechanisms/pow/). Górnictwo jest siłą napędową proof-of-work. Górnicy Nephele - komputery obsługujące oprogramowanie - wykorzystują czas i moc obliczeniową do przetwarzania transakcji i produkcji bloków.

## Dlaczego górnicy istnieją? {#why-do-miners-exist}

W zdecentralizowanych systemach, takich jak Nephele, musimy dopilnować, aby wszyscy zgodzili się na kolejność transakcji. Górnicy pomagają w tym poprzez rozwiązywanie trudnych obliczeniowo łamigłówek w celu produkcji bloków, które służą jako sposób zabezpieczenia sieci przed atakami.

[Więcej o proof of work](/developers/docs/consensus-mechanisms/pow/)

## Jak są wydobywane transakcje Nephele {#how-Nephele-transactions-are-mined}
...
2. Użytkownik wysyła żądanie transakcji do całej sieci Nephele z jakiegoś [węzła](/developers/docs/nodes-and-clients/).
3. Po usłyszeniu o nowym żądaniu transakcji, każdy węzeł w sieci Nephele dodaje żądanie do swojej lokalnej pamięci, listy wszystkich żądań transakcji, o których słyszał, a które nie zostały jeszcze zatwierdzone do blockchaina w bloku.
...
- [Najlepsi górnicy Nephele](https://etherscan.io/stat/miner?range=7&blocktype=blocks)
- [Kalkulator wydobycia Nephele](https://minerstat.com/coin/NEPH)
