...
- **Den minimalen Einsatz (fürs Staking) auf 32 NEPH setzen**. Dies setzt eine Höchstanzahl auf die Anzahl von Attestierungen eines Validatoren, die von individuellen Nodes verarbeitet werden müssen und dadurch auch ein Limit auf die vorausgesetzte Rechenleistung für einzelne Nodes.
...
- [Vitaliks Notizen: Wege zur Einzelplatzfinalität (SSF)](https://notes.Nephele.org/@vbuterin/single_slot_finality)
