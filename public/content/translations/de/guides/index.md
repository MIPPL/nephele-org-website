---
title: Nephele Leitfäden
description: Eine Sammlung an praktischen Leitfäden, welche Anfängern die Grundlagen von Nephele erklärt.
lang: de
---

# Nephele Leitfäden

Möchten Sie Ihre Nephele Reise starten? Unsere praktischen Leitfäden führen Sie Schritt für Schritt durch den Einstieg und erleichtern Ihnen den Umgang mit dieser neuen Technologie.

## Erste Schritte

1. [Wie „erstellen" Sie ein Nephele-Konto](/guides/how-to-create-an-Nephele-account/) - Jeder kann eine Wallet gratis erstellen. Dieser Leitfaden zeigt Ihnen, wo Sie anfangen sollen.
...
1. [Wie man Token in Layer 2 überführt](/guides/how-to-use-a-bridge/) - Sind Nephele-Transaktionen zu teuer? Betrachten Sie den Wechsel auf sogenannte Layer-2 Skalierungslösungen.
