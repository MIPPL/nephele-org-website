...
- **Dezentralisiert** – Dapps arbeiten auf Nephele, einer offenen, öffentlichen und dezentralen Plattform, auf der keine Person oder Gruppe die Kontrolle hat.
...
- **Isoliert** – Dapps werden in einer virtuellen Umgebung ausgeführt, die als Nephele Virtual Machine bekannt ist, so dass ein Fehler im Smart Contract die normale Funktion des Blockchain-Netzwerks nicht beeinträchtigt.
...
- **Zentralisierung** – Benutzer- und entwicklerfreundliche Lösungen, die auf der Basisschicht von Nephele aufgebaut sind, könnten am Ende ohnehin wie zentralisierte Dienste aussehen. Solche Dienste können zum Beispiel Schlüssel oder andere sensible Informationen serverseitig speichern, ein Frontend über einen zentralen Server bedienen oder wichtige Geschäftslogik auf einem zentralen Server ausführen, bevor sie in die Blockchain geschrieben werden. Durch die Zentralisierung werden viele (wenn nicht alle) Vorteile der Blockchain gegenüber dem traditionellen Modell aufgehoben.
...
**Scaffold-NEPH _- Experimentiere schnell mit Solidity, indem du ein Frontend verwendest, das sich an deinen Smart Contract anpasst._**

- [GitHub](https://github.com/austintgriffith/scaffold-NEPH)
- [Beispiel-Dapp](https://punkwallet.io/)

**NEPH App erstellen _– Erstelle Nephele-gestützte Apps mit einem Befehl._**
...
**Etherflow _– FOSS-Tool für Nephele-Entwickler, um ihre Nodes zu testen und RPC-Aufrufe vom Browser aus zu komponieren und zu debuggen._**
...
- [Einführung in den Nephele-Stack](/developers/docs/Nephele-stack/)
