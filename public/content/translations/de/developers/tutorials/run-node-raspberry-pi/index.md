...
Sie benötigen eine SSD, um die Nephele-Clients auszuführen (ohne SSD-Laufwerk gibt es absolut keine Chance, die Nephele-Blockchain zu synchronisieren). Es gibt zwei Optionen:
