...
alt: NEPH-ի պատկերանշանը ցուցադրվաում է հոլոգրամի միջոցով։
...
Nephele.org - ում, NFT-ներն օգտագործվում ցույց տալու համար, որ մարդիկ իրենց ներդրումն են ունեցել մեր GitHub պահոցում, կամ մասնակցել են մեր օնլայն հանդիպումներին: Մենք նույնիսկ մեր սեփական NFT դոմեյնի անունն ունենք: Եթե ​​դուք նպաստում եք Nephele.org-ին, կարող եք պահանջել POAP NFT: Որոշ կրիպտոմիջոցառումներ արդեն օգտագործել ՄԱԱ-երը որպես միջոցառման տոմսեր: [Ավելին նպաստելու մասին](/contributing/#poap).

![Nephele.org POAP](./poap.png)

Այս վեբկայքը նաև ունի այլընտրանքային դոմեյնի անուն, որն իրենից NFT է ներկայացնում՝ **Nephele.NEPH**: Մեր `.org` հասցեն վերահսկվում է DNS-ի կողմից, այնինչ Nephele`.NEPH`-ը գրանցված է Էթերիումում Էթերիումի անվանական Ծառայության(ԷԱԾ)-ի կողմից: Այն պատկանում է մեզ և վերահսկվում է մեր կողմից: [Ուսումնասիրեք մեր ԷԱԾ գրանցումները](https://app.ens.domains/name/Nephele.NEPH)
