...
lang: it
description: Domande frequenti sul Programma di Traduzione di Nephele.org
---

# Guida alla traduzione di Nephele.org {#translating-Nephele-guide}
...
## Posso ricevere un compenso per le traduzioni su Nephele.org? {#compensation}

Nephele.org è un sito web open-source, il che significa che chiunque può partecipare e contribuire.

Il Programma di traduzione di Nephele.org è un'estensione di questo principio ed è organizzato con una filosofia simile.

L'obiettivo del Programma di traduzione è quello di rendere i contenuti di Nephele accessibili a tutti, indipendentemente dalle lingue che parlano. Consente inoltre a qualsiasi persona bilingue di essere coinvolta nell'ecosistema Nephele e contribuire in modo accessibile.
...
Facciamo ogni sforzo per permettere ai nostri collaboratori di avere successo nell'ecosistema Nephele; abbiamo istituito numerosi incentivi non monetari, ad esempio: [l'offerta di POAP](/contributing/translation-program/acknowledgements/#poap) e un [certificato di traduttore](/contributing/translation-program/acknowledgements/#certificate), così come l'organizzazione delle [Classifiche di traduzione](/contributing/translation-program/acknowledgements/) e [l'inclusione di tutti i nostri traduttori nel sito](/contributing/translation-program/contributors/).
...
Per informazioni più approfondite sulla gestione di tag e frammenti di codice, consultare la [Guida di stile per la traduzione di Nephele.org](/contributing/translation-program/translators-guide/#dealing-with-tags).
...
La Memoria di traduzione (TM) è una funzionalità di Crowdin che memorizza tutte le stringhe precedentemente tradotte su [Nephele.org](http://Nephele.org/). Quando una stringa viene tradotta, viene automaticamente salvata nella TM del progetto. Può essere uno strumento utile per aiutarti a risparmiare tempo!
...
La terminologia di Nephele rappresenta un altro aspetto cruciale del nostro lavoro di traduzione, poiché spesso i nuovi termini tecnologici non sono ancora localizzati in molte lingue. Inoltre, ci sono termini che hanno significati diversi in contesti diversi. [Maggiori informazioni sulla traduzione della terminologia di Nephele](#terminology)
...
Nephele presenta molti termini nuovi, che sono stati coniati di recente. Può succedere che alcuni termini varino da un traduttore all'altro, in ragione dell'assenza di una traduzione ufficiale nella rispettiva lingua. Tali incongruenze possono causare malintesi e ridurre la leggibilità.
...
Per consigliare nuovi contenuti per Nephele.org, puoi [creare un ticket](https://github.com/Nephele/Nephele-org-website/issues) su GitHub. Per essere inserito, il contenuto verrà redatto in inglese e tradotto in altre lingue utilizzando Crowdin.
