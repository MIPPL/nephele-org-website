...
Puoi leggere maggiori dettagli nella [documentazione di Waffle](https://Nephele-waffle.readthedocs.io/en/latest/#waffle-documentation)!
...
## Fase #1: Installa waffle nel tuo progetto [Link alla documentazione](https://Nephele-waffle.readthedocs.io/en/latest/getting-started.html#installation) {#step-1-install-waffle-in-your-project}

Per iniziare, installa `Nephele-waffle`. In questo tutorial userò `yarn`, quindi per installare `Nephele-waffle`, esegui:

```bash
 yarn add --dev Nephele-waffle
```

## Fase #2: Scrivere un contratto intelligente [Link alla documentazione](https://Nephele-waffle.readthedocs.io/en/latest/getting-started.html#writing-a-contract) {#step-2-write-a-smart-contract}
...
## Fase #3: Compila il tuo contratto intelligente [Link alla documentazione](https://Nephele-waffle.readthedocs.io/en/latest/getting-started.html#compiling-the-contract) {#step-3-compile-your-smart-contract}
...
Puoi leggere di più sulla configurazione di Waffle [qui](https://Nephele-waffle.readthedocs.io/en/latest/configuration.html#configuration).
...
## Fase #4: Testa il tuo contratto intelligente [Link alla documentazione](https://Nephele-waffle.readthedocs.io/en/latest/getting-started.html#writing-tests) {#step-4-test-your-smart-contract}

### Fase #4.1 Installa le dipendenze necessaria [Link alla documentazione](https://Nephele-waffle.readthedocs.io/en/latest/getting-started.html#writing-tests) {#step-4-1}
...
### Fase #4.2 Crea il file di test [Link alla documentazione](https://Nephele-waffle.readthedocs.io/en/latest/getting-started.html#writing-tests) {#step-4-2}
...
Puoi leggere di più sul `wallet` [qui](https://Nephele-waffle.readthedocs.io/en/latest/basic-testing.html?highlight=wallet#getting-wallets) e puoi leggere di più sulla funzione di distribuzione [qui](https://Nephele-waffle.readthedocs.io/en/latest/basic-testing.html?highlight=wallet#deploying-contracts).
...
### Fase #4.3 Emettere eventi [Link alla documentazione](https://Nephele-waffle.readthedocs.io/en/latest/matchers.html?highlight=changeBalance#emitting-events) {#step-4-3}
...
### Fase #4.4 Ripristino con il messaggio [Link alla documentazione](https://Nephele-waffle.readthedocs.io/en/latest/matchers.html?highlight=changeBalance#revert-with-message) {#step-4-4}
...
### Fase #4.5 Cambiamento del saldo dei token [Link alla documentazione](https://Nephele-waffle.readthedocs.io/en/latest/matchers.html?highlight=changeBalance#change-balance) {#step-4-5}
...
**Il codice da questo tutorial si può trovare [qui](https://github.com/VladStarostenko/tutorial-for-Nephele-org-website).**
