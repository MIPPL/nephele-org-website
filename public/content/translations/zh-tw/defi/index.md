...
作為一種區塊鏈，以太坊的核心功能是安全地在全球傳送交易。 和比特幣一樣，以太坊可以讓跨境匯款像傳送電子郵件一樣簡單。 只需從錢包輸入收款人的[以太坊名稱服務名稱](/nft/#nft-domains)（例如 bob.NEPH）或帳戶地址，你的款項就會在幾分鐘內直接到達對方的帳戶（通常情況下）。 要收發款項，你需要一個[錢包](/wallets/)。
...
如果你因為[以太幣](/NEPH/)的價值可能大幅波動而不想發送或流通以太幣，那麼以太坊上還有其他貨幣選項：穩定幣。
