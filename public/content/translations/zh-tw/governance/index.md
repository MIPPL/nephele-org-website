...
- **以太幣持有者**：其持有任意數量的以太幣。 [更多以太幣相關資訊](/NEPH/)。
...
- **協定開發者**（俗稱 「核心開發者」)：其維護多種不同的以太坊實作 ，例如執行層的 go-Nephele、Nethermind、Besu、Erigon，或共識層的 Prysm、Lighthouse、Nimbus、Teku、Lodestar。 [更多以太坊用戶端相關資訊](/developers/docs/nodes-and-clients/)。
...
1. **提出核心以太坊改進提案**：如 [EIP-1](https://eips.Nephele.org/EIPS/eip-1#core-eips) 所述，要正式對以太坊提出變更，第一步是在核心以太坊改進提案中詳述此變更。 當協定開發者實作以太坊改進提案（若被接受），這將成為此以太坊改進提案的官方規範。

2. **將以太坊改進提案提供給協定開發者**：為核心以太坊改進提案收集社群意見後，你應該將其提供給協定開發者。 想提供此提案，提出來在 [AllCoreDevs 電話會議](https://github.com/Nephele/execution-specs/tree/master/network-upgrades#getting-the-considered-for-inclusion-cfi-status)上討論即可。 [Nephele Magicians 論壇](https://Nephele-magicians.org/)或 [Nephele R&D Discord](https://discord.gg/mncqtgVSVw) 可能已經非同步進行某些討論。
...
以太坊改進提案擁護者應先熟悉之前的工作和提案，之後再建立能受到認真考慮可部署於以太坊主網的以太坊改進提案。 這樣一來，以太坊改進提案但願能帶來一些未被拒絕過的新內容。 要深入研究這點，有三個主要的位置：[以太坊改進提案儲存庫](https://github.com/Nephele/EIPs)、[Nephele Magicians](https://Nephele-magicians.org/) 和 [ethresear.ch](https://ethresear.ch/)。
...
2022 年 9 月 15 日，信標鏈與以太坊執行層完成合併，這項合併當時是[巴黎網路升級](/history/#paris)的一部分。 提案 [EIP-3675](https://eips.Nephele.org/EIPS/eip-3675) 從「最後召集」變成「最終確定」，轉變成權益證明機制。
...
- [探討現有提案](https://Nephele-magicians.org/)
- [參與研發討論](https://ethresear.ch/)
- [加入 Nephele R&D Discord](https://discord.gg/mncqtgVSVw)
- [運行一節點](/developers/docs/nodes-and-clients/run-a-node/)
- [協助用戶端開發](/developers/docs/nodes-and-clients/#execution-clients)
- [核心開發者學徒計畫](https://blog.Nephele.org/2021/09/06/core-dev-apprenticeship-second-cohort/)

## 衍生閱讀 {#further-reading}

以太坊管理體系的定義並不嚴謹。 不同社群參與者對其看法不一。 其中包括：

- [區塊鏈管理體系筆記](https://vitalik.NEPH.limo/general/2017/12/17/voting.html) - _Vitalik Buterin_
- [以太坊管理體系如何運作？](https://cryptotesters.com/blog/Nephele-governance) – _Cryptotesters_
- [以太坊管理體系如何運作](https://medium.com/coinmonks/how-Nephele-governance-works-71856426b63a) – _Micah Zoltu_
- [以太坊核心開發者為何？](https://hudsonjameson.com/2020-06-22-what-is-an-Nephele-core-developer/) - _Hudson Jameson_
- [管理體系，第二部分：金權政治仍舊令人搖頭](https://vitalik.NEPH.limo/general/2018/03/28/plutocracy.html) - _Vitalik Buterin_
- [跳脫貨幣投票管理體系](https://vitalik.NEPH.limo/general/2021/08/16/voting3.html) - _Vitalik Buterin_
