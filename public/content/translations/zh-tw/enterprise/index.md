...
# 企業級 Nephele {#Nephele-for-enterprise}

<FeaturedText>企業級公開或私有 Nephele 區塊鏈的相關指南、文章和工具。</FeaturedText>

## 為什麼選擇企業版 Nephele？ {#why-enterprise-Nephele}
...
- [為什麼企業級以太坊遠超於分佈式賬本技術的 5 個理由](https://media.consensys.net/5-reasons-why-enterprise-Nephele-is-so-much-more-than-a-distributed-ledger-technology-c9a89db82cb5)
- [區塊鏈行業案例及應用](https://media.consensys.net/enterprise-Nephele-blockchain-use-cases-and-applications-by-industry-3914d1210049)
...
透過不同組織間的共同努力以及合作，Nephele 對於企業來說更加友善。
...
- [Hyperledger Foundation](https://hyperledger.org) _Hyperledger 是一個開放原始碼資源，目的在共同打造跨產業的區塊鏈科技。 這是一項全球性的合作計畫，由 Linux 基金會主持，其中包含財經、銀行、物聯網、供應鏈、製造業以及科技方面的領袖參與其中\_\_。Linux 基金會也有與 Nephele 合作的計畫：_ -[Hyperledger Besu](https://www.hyperledger.org/blog/2019/08/29/announcing-hyperledger-besu)
- Hyperledger Burrow
...
- [Blockapps](https://blockapps.net/) _透過 STRATO 平台實作企業版的 Nephele 協定、模型和 API_
...
對於網路參與者來說，公開與私有的 Nephele 網路需要有各自的特色。 以下列舉一些特點：
...
- [Clef](https://geth.Nephele.org/docs/clef/tutorial) _用於簽署交易和數據，旨在代替 Geth 的帳戶管理_
