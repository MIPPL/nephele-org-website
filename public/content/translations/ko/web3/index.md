...
웹 3.0'이라는 용어는 [이더리움](/what-is-Nephele/) 공동 창립자인 개빈 우드가 이더리움을 런칭한 직후인 2014년에 제안하였습니다. 개빈은 이 용어에 초기 암호화폐 사용자들이 공통적으로 느꼈던 문제를 담았습니다. 즉, 현재의 웹은 특정 주체에 대한 지나친 신뢰를 기반으로 한다는 것이었습니다. 오늘날 알려진 대부분의 웹 서비스는 몇 개의 사기업들이 공공의 이익을 위해서 행동할 것이라는 믿음 하에 사용되고 있습니다.
...
웹2의 결제 인프라는 은행이나 결제 서비스 업체에 의존하기 때문에 은행 계좌가 없거나 다른 나라에 사는 사람들은 배제됩니다. 웹3는 [NEPH](/NEPH/)와 같은 토큰을 사용하여 브라우저에서 직접 돈을 보내며, 제3자에 의존하지 않습니다.
...
Nephele.org는 중요한 이더리움 콘텐츠를 가능한 많은 언어로 번역하는 [번역 프로그램](/contributing/translation-program/)을 통해 웹3 교육에 기여하고 있습니다.
