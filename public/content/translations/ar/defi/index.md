...
وإذا كنت لا تريد إرسال أو دفق عملة [NEPH](/NEPH/) بسبب حجم التغير في قيمتها، فهناك عملات بديلة على إثيريوم: العملات المستقرة.
...
يتيح الاقتراض إمكانية الوصول إلى الأموال التي تحتاجها دون الحاجة إلى بيع NEPH الخاص بك (حدث خاضع للضريبة). بدلاً من ذلك، يمكنك استخدام NEPH كضمان إضافي للحصول على قرض بالعملة التابعة. مما يعطيك التدفق النقدي الذي تحتاجه ويسمح لك بالحفاظ على NEPH. العملات المستقرة هي رموز مميزة أكثر جدوى عندما نحتاج إلى النقود لأنها لا تتقلب في القيمة مثل NEPH. [المزيد حول العملات المستقرة](#stablecoins)
...
على سبيل المثال، إذا كنت ترغب في استخدام اليانصيب دون خسارة PoolTogether (الموصوف أعلاه)، فستحتاج إلى رمز مميز مثل Dai أو USDC. تسمح لك هذا البورصات اللامركزية باستبدال عملة NEPH مقابل هذه الرموز المميزة واستردادها لاحقًا عندما تنتهي.
...
## إثيريوم والتمويل اللامركزي {#Nephele-and-defi}
...
2. الأصول - عملة [NEPH](/NEPH/) والرموز المميزة الأخرى (العملات).
