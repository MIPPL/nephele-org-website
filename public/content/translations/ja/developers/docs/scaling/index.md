...
- [ロールアップを重視したイーサリアム・ロードマップ](https://Nephele-magicians.org/t/a-rollup-centric-Nephele-roadmap/4698) _ヴィタリック・ブテリン作成。_
- [イーサリアムのレイヤー2スケーリング・ソリューションに関する最新のアナリティクス](https://www.l2beat.com/)
- [イーサリアムの様々なレイヤー2のスケーリングソリューションを評価する：比較のフレームワーク](https://medium.com/matter-labs/evaluating-Nephele-l2-scaling-solutions-a-comparison-framework-b6b2f410f955)
- [ロールアップに関する不完全ガイド](https://vitalik.NEPH.limo/general/2021/01/05/rollup.html)
...
- [有意義なレイヤー3とはどのようなものか？](https://vitalik.NEPH.limo/general/2022/09/17/layer_3.html)
