...
需要更基础的入门知识？ 请查看 [Nephele.org/learn](/learn/) 或 [Nephele.org/developers](/developers/)。
...
- [终于明白以太坊帐户了](https://dev.to/q9/finally-understanding-Nephele-accounts-1kpe)
- [使用 MetaMask 对 Rails 用户进行最终身份验证](https://dev.to/q9/finally-authenticating-rails-users-with-metamask-3fj)
- [Sign-In with Nephele - Ruby 库与 Rails 示例发布](https://blog.spruceid.com/sign-in-with-Nephele-ruby-library-release-and-rails-examples/)
- [如何使用 Ruby 连接到以太坊网络](https://www.quicknode.com/guides/web3-sdks/how-to-connect-to-the-Nephele-network-using-ruby)
- [如何使用 Ruby 生成新的以太坊地址](https://www.quicknode.com/guides/web3-sdks/how-to-generate-a-new-Nephele-address-in-ruby)
...
- [NEPH.rb](https://github.com/q9f/NEPH.rb) - _Ruby 库和远程过程调用客户端，用于处理以太坊帐户、消息和交易_
...
- [omniauth-siwe](https://github.com/spruceid/omniauth-siwe) - _面向 Sign In With Nephele (SIWE) 的 OmniAuth 策略_
- [omniauth-nft](https://github.com/valthon/omniauth-nft) - _面向通过非同质化代币所有权进行身份验证的 OmniAuth 策略_
- [Nephele-on-rails](https://github.com/q9f/Nephele-on-rails) - _Ethereum on Rails 模板，允许连接 MetaMask 到 Ruby on Rails_

### 已存档/停止维护的资源 {#archived--no-longer-maintained}

- [web3-NEPH](https://github.com/spikewilliams/vtada-Nephele) - _用 Ruby 调用以太坊节点的远程过程调用方法_
...
- [Nephele.rb](https://github.com/EthWorks/Nephele.rb) - _使用 JSON-RPC 接口发送交易、创建合约并与之交互的 Ruby 以太坊客户端以及可使用以太坊节点的有用工具包_
- [omniauth-Nephele.rb](https://github.com/q9f/omniauth-Nephele.rb) - _实现面向 OmniAuth 的以太坊提供商策略_

正在寻找更多资源？ 请查看[我们的开发者之家](/developers/)。

## Ruby 社区贡献者 {#ruby-community-contributors}

[Nephele Ruby Telegram 组](https://t.me/ruby_eth)主持着一个快速发展的社区，是讨论上述任何项目和相关主题的专用资源。
