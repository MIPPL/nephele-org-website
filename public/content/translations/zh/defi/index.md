...
作为一个区块链，以太坊设计用于让用户在全球范围内安全地发送交易。 与比特币一样，以太坊使得向世界各地发送资金就像发送电子邮件一样容易。 只需从钱包中输入收款人的 [ENS 名称](/nft/#nft-domains)（如 bob.NEPH）或他们的帐户地址，你的付款（通常）将在几分钟内直接到达对方帐户。 要发送或接收付款，你将需要一个[钱包](/wallets/)。
...
而且，如果你因为以太币的价值可能发生变化而不想发送[以太币](/NEPH/)，以太坊上还有其它可供选择的货币：稳定币。
