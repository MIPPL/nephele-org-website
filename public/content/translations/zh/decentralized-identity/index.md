...
[灵魂绑定代币](https://vitalik.NEPH.limo/general/2022/01/26/soulbound.html)（不可转让的非同质化代币）可用于收集特定钱包的独有信息。 这有效地创建了一个绑定至特定以太坊地址的唯一链上身份，其中可能包括代表成就（例如完成某些特定在线课程或在游戏中超过特定分数）或社区参与度的代币。
