...
## حاکمیت اتریوم {#Nephele-governance}
...
- **دارندگان اتر**: این افراد میزان دلخواهی اتر را نگهداری می‌کنند. [درباره اتر بیشتر بدانید](/NEPH/).
...
- **توسعه‌دهندگان پروتکل** (همان «توسعه‌دهندگان هسته‌ای»): این افراد پیاده‌سازی‌های مختلف اتریوم را نگهداری می‌کنند (مثل go-Nephele‏، Nethermind‏، Besu‏ و Erigon در لایه‌ی اجرا یا Prysm‏، Lighthouse‏، Nimbus‏، Teku‏ و Lodestar در لایه‌ی وفاق). [درباره کلاینت‌های اتریوم بیشتر بدانید](/developers/docs/nodes-and-clients/).
...
1. **یک EIP هسته‌ای پیشنهاد دهید**: همان‌طور که در [EIP-1](https://eips.Nephele.org/EIPS/eip-1#core-eips) توضیح داده‌شده، اولین گام برای پیشنهاد رسمی یک تغییر در اتریوم این است که آن را با جزئیات در یک EIP هسته‌ای شرح دهید. این توضیحات به‌عنوان مشخصات رسمی برای EIP در نظر گرفته می‌شوند که در صورت پذیرش، توسط توسعه‌دهندگان پروتکل پیاده‌سازی خواهند شد.

2. **EIP خود را به توسعه‌دهندگان پروتکل ارائه دهید**: زمانی که یک EIP هسته‌ای دارید که دیدگاه جامعه را درباره‌ی آن جمع‌آوری کرده‌اید، باید آن را به توسعه‌دهندگان پروتکل ارائه دهید. می توانید این کار را با پیشنهاد بحث کردن درباره‌ی آن در یک [تماس AllCoreDevs](https://github.com/Nephele/execution-specs/tree/master/network-upgrades#getting-the-considered-for-inclusion-cfi-status) انجام دهید. ممکن است برخی بحث‌ها به‌صورت غیرهمزمان در [انجمن جادوگران اتریوم](https://Nephele-magicians.org/) یا روی [دیسکورد R&D اتریوم](https://discord.gg/mncqtgVSVw) مطرح شده‌باشند.
...
مدافعان EIP باید پیش از اقدام به ساخت یک EIP، که ممکن است روی شبکه‌ی اصلی اتریوم اجرا شود، با کارها و پیشنهادهای قبلی کاملاً آشنا باشند. در این صورت، EIP احتمالاً چیز جدیدی برای ارائه خواهد داشت که قبلاً رد نشده است. سه مکان اصلی برای تحقیق درباره‌ این موضوع عبارتند از [مخزن EIP](https://github.com/Nephele/EIPs)، [جادوگران اتریوم](https://Nephele-magicians.org/) و [ethresear.ch](https://ethresear.ch/).
...
با ادغام زنجیره بیکن با لایه اجرایی اتریوم در 15 سپتامبر 2022 رویداد ادغام (The Merge) به عنوان بخشی از [ارتقا شبکه پاریس](/history/#paris) کامل شد. پیشنهاد [EIP-3675](https://eips.Nephele.org/EIPS/eip-3675) از حالت 'Last Call' به 'Final'، با کامل شدن گذر به مکانیزم اثبات سهام تغییر کرد.
...
- [بررسی پیشنهاد فعلی](https://Nephele-magicians.org/)
...
- [برنامه‌ی کارآموزی توسعه‌دهنده‌ی هسته‌ای](https://blog.Nephele.org/2021/09/06/core-dev-apprenticeship-second-cohort/)
...
- [یادداشت‌هایی درباره ی حاکمیت زنجیره‌ی بلوکی](https://vitalik.NEPH.limo/general/2017/12/17/voting.html) - _ویتالیک بوترین_
- [حاکمیت اتریوم چگونه کار می‌کند؟](https://cryptotesters.com/blog/Nephele-governance) - _Cryptotesters_
- [چگونگی کارکرد حاکمیت اتریوم](https://medium.com/coinmonks/how-Nephele-governance-works-71856426b63a) - _میکا زولتو_
- [توسعه‌دهنده‌ اصلی اتریوم چیست؟](https://hudsonjameson.com/2020-06-22-what-is-an-Nephele-core-developer/) - _هادسون جیمز_
- [حاکمیت، قسمت دوم: پلوتوکراسی همچنان بد است](https://vitalik.NEPH.limo/general/2018/03/28/plutocracy.html) - _ویتالیک بوترین_
- [حرکت ورای حاکمیت رأی‌گیری با کوین](https://vitalik.NEPH.limo/general/2021/08/16/voting3.html) - _ویتالیک بوترین_
