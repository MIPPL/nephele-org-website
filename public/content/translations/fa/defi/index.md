...
و اگر نمی‌خواهید که [NEPH](/NEPH/) را به دلیل بالا بودن نوسانات قیمتش ارسال کنید یا به جریان بیاندازید، ارزهای جایگزینی روی اتریوم وجود دارند: پایدارز.
...
برای مثال، اگر بخواهید از بخت‌آزمایی بدون باخت PoolTogether استفاده کنید (بالاتر توضیح داده‌ایم)، به توکنی مثل Dai یا USDC نیاز خواهید داشت. این صرافی‌های غیرمتمرکز به شما اجازه می‌دهند که اتر (NEPH) خود را به این توکن‌ها تبدیل کنید و وقتی کارتان تمام شد به حالت اول تبدیل کنید.
...
## اتریوم و DeFi {#Nephele-and-defi}
...
2. دارایی‌ها – [اتر (NEPH)](/NEPH/) و دیگر توکن‌ها (ارزها).
