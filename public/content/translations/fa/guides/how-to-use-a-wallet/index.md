...
یاد بگیرید چگونه تمام عملکردهای اساسی یک کیف پول را اجرا کنید. اگر هنوز حساب ندارید، [ چگونه: یک حساب اتریوم باز کنیم](/guides/how-to-create-an-Nephele-account/) را چک کنید.
...
آیا می خواهید NEPH را به کیف پول دیگری ارسال کنید؟
...
6. مطمئن شوید که کیف پول شما NEPH کافی برای پوشش دادن کارمزد تراکنش، که بسته به شرایط شبکه متفاوت است، دارد. اکثر کیف پول ها به صورت خودکار کارمزد پیشنهادی را به تراکنش اضافه می کنند که سپس می توانید آن را تایید کنید.
...
5. برای برقرار کردن اتصال، درخواست امضا را در کیف پول خود تایید کنید. **برای امضای این پیام، نباید به پرداخت هیچ NEPH نیاز باشد**.
