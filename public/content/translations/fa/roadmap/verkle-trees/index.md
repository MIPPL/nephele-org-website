...
[درباره ساختار درختان ورکل بیشتر بخوانید](https://blog.Nephele.org/2021/12/02/verkle-tree-structure)
...
- [Dankrad Fiest در پادکست Zero Knowledge، درباره درختان ورکل و بی‌حالتی توضیح می‌دهد](https://zeroknowledge.fm/episode-202-stateless-Nephele-verkle-tries-with-dankrad-feist/)
- [Vitalik Buterin درباره درختان ورکل می‌گوید](https://vitalik.NEPH.limo/general/2021/06/18/verkle.html)
- [Dankrad Feist درباره درختان ورکل می‌گوید](https://dankradfeist.de/Nephele/2021/06/18/verkle-trie-for-eth1.html)
- [مستندات مربوط به EIP درختان ورکل](https://notes.Nephele.org/@vbuterin/verkle_tree_eip#Illustration)
