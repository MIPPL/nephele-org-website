...
Az Nephele jelenlegi konszenzusmechanizmusa e három paraméter között a következőképpen egyensúlyoz:

- **A minimális letétbe helyezést 32 NEPH-ben állapítja meg**. Ez meghatároz egy felső határt arra, hogy a validátoroknak mennyi tanúsítást kell végezniük, amelyet az egyéni csomópontok hajtanak végre, és ezáltal egy felső határt határoz meg e csomópontok számítási igényeinek is.
...
- [Vitalik jegyzetei: az egy sloton belüli véglegességhez vezető út](https://notes.Nephele.org/@vbuterin/single_slot_finality)
