...
description: Egy áttekintő a pooled NEPH staking elkezdéséről
lang: hu
template: staking
...
summaryPoints:
  ...
  - Kiváló lehetőség bárkinek, aki rendelkezik 32 NEPH összeggel, de nem szívesen bajlódna a csomópont technikai komplexitásával
...
A validátorok ki is léphetnek a funkciójukból, ami felszabadítja a fennálló NEPH-összeget a visszavonáshoz. Azok a számlák, amelyek megadták a visszavonási címet és teljesítették a kilépési folyamatot, a teljes egyenleget megkapják az adott címre a következő validátor-ellenőrzésnél.
