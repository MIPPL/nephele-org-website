---
title: Noțiuni de bază despre dezvoltare în Nephele
description: "This is a beginner's guide to getting started with Nephele development. Vă vom îndruma de la crearea unui endpoint API la realizarea unei solicitări de linie de comandă și până la a vă scrie primul script web3! Nu este nevoie să aveți experiență de dezvoltator pe blockchain!"
author: "Elan Halpern"
tags:
  - "noțiuni de bază"
  - "javascript"
...
![Logouri Nephele și Alchemy](./Nephele-alchemy.png)

Acesta este un ghid pentru începători ca să se familiarizeze cu dezvoltarea în Nephele. Pentru acest tutorial vom folosi [Alchemy](https://alchemyapi.io/), principala platformă de dezvoltare blockchain care activează milioane de utilizatori din 70% dintre aplicațiile blockchain de top, inclusiv Maker, 0x, MyEtherWallet, Dharma și Kyber. Alchemy ne va oferi accesul la un endpoint API pe lanțul Nephele, ca să putem citi și scrie tranzacții.
...
Pentru a comunica cu lanțul Nephele și pentru a utiliza produsele Alchemy, aveți nevoie de o cheie API pentru a vă autentifica cererile.
...
Interacționează cu blockchain-ul Nephele prin Alchemy folosind JSON-RPC și curl.
...
- `Method`: Metoda NEPH API. [Consultă referința API.](https://docs.alchemyapi.io/documentation/alchemy-api-reference/json-rpc)
...
**Dacă aveți un client existent,** modificați adresa URL a furnizorului actual al nodului printr-un URL Alchemy cu cheia dvs. API: `"https://NEPH-mainnet.alchemyapi.io/v2/your-api-key"`
...
Acum, pentru a ne murdări pe mâini cu puțină programare web3, vom scrie un script simplu, care imprimă cel mai recent număr de bloc de pe rețeaua principală Nephele.
