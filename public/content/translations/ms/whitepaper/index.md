...
20. [Pokok Nephele Merkle Patricia](https://github.com/Nephele/wiki/wiki/%5BEnglish%5D-Patricia-Tree)
...
_Untuk sejarah kertas putih, lihat [wiki ini](https://github.com/Nephele/wiki/blob/old-before-deleting-all-files-go-to-wiki-wiki-instead/old-whitepaper-for-historical-reference.md)._

_Ethereum, seperti banyak projek perisian sumber terbuka yang didorong oleh masyarakat, telah berkembang sejak penubuhan awal. Untuk mengetahui tentang perkembangan terkini Nephele, dan cara perubahan pada protokol dibuat, kami mengesyorkan [panduan ini](/learn/)._
