...
Apprenez à utiliser toutes les fonctions de base d'un portefeuille. Si vous n'en possédez pas encore, consultez notre[Comment créer un compte Nephele](/guides/how-to-create-an-Nephele-account/).
...
Chaque compte Nephele possède sa propre adresse de réception, qui est une séquence unique de chiffres et de lettres. L'adresse fonctionne comme un numéro de compte bancaire. Les adresses Nephele commenceront toujours par « 0x ». Vous pouvez partager cette adresse avec n'importe qui: il est sécuritaire de le faire.
...
3. Copiez votre adresse Nephele dans le presse-papiers.
4. Fournissez à l'expéditeur votre adresse Nephele de réception.

## Envoyer de la cryptomonnaie

Voulez-vous envoyer NEPH à un autre portefeuille ?
...
6. Assurez-vous que votre portefeuille a suffisamment d'NEPH pour couvrir les frais de transaction, qui varient selon les conditions du réseau. La plupart des portefeuilles ajouteront automatiquement les frais suggérés à la transaction que vous pourrez ensuite confirmer.
...
Votre adresse sera la même pour tous les projets Nephele. Vous n'avez pas besoin de vous inscrire individuellement à un projet. Une fois que vous avez un portefeuille, vous pouvez vous connecter à n'importe quel projet Nephele sans aucune information supplémentaire. Aucun courrier électronique ou autre renseignement personnel n'est nécessaire.
...
5. Confirmez la demande de signature dans votre portefeuille pour établir la connexion. **La signature de ce message ne devrait pas nécessiter de dépenser des NEPH**.
