...
- **[Waffle](https://Nephele-waffle.readthedocs.io/en/latest/)** - _Framework pour le développement et le test de contrats intelligents avancés (basé sur ethers.js)_.
