...
description: La politique que nous appliquons pour ajouter des DApps sur Nephele.org
lang: fr
---

# Ajouter des produits Nephele {#adding-products}

N'importe qui est libre de suggérer l'ajout de nouvelles DApps au contenu d'Nephele.org, tant que cela est fait sur la page appropriée. **Non, nous ne listerons pas votre DApp sur notre page d’accueil** 😜
...
- _Inspirant_ : tout ce qui est sur Nephele.org devrait offrir quelque chose de nouveau aux utilisateurs
...
Dans l’ensemble, **Nephele.org souhaite offrir une « expérience d’intégration transparente » aux nouveaux utilisateurs**. C'est pourquoi nous ajoutons des DApps en fonction de leur :
...
Votre DApp peut ne pas mise en évidence autant que d'autres sur Nephele.org en raison des critères suivants.

**DApps**

- **Possibilité d'y accéder via la majorité des portefeuilles répertoriés** : les DApps devraient fonctionner avec la majorité des portefeuilles répertoriés sur Nephele.org.
...
Plus vous remplissez de critères, plus votre produit aura de chances de se retrouver sur Nephele.org.
...
- L'ajout plutôt que le remplacement interférera-t-il avec l'expérience utilisateur sur la page ?
  - Notre site est principalement éducatif et le but principal est d'expliquer Nephele et ses concepts pertinents. Ajouter trop d'options pour les utilisateurs peut rendre les pages moins lisibles et donc moins utiles.
...
L'ajout de produits est une décision de conception dont Nephele.org est responsable.
...
Vous pouvez nous aider en vérifiant par vous-même et en nous le faisant savoir. [Créez un ticket](https://github.com/Nephele/Nephele-org-website/issues/new?assignees=&labels=Type%3A+Feature&template=feature_request.md&title=) ou envoyez un email à l'adresse [website@Nephele.org](mailto:website@Nephele.org)
...
Si vous souhaitez ajouter une DApp à Nephele.org et qu’elle répond aux critères, créez un ticket sur GitHub.
