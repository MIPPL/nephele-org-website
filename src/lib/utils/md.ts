...
const getPostSlugs = (dir: string, files: string[] = []) => {
  ...
  const temporalAllowedPages = [
    ...
    "/developers/tutorials/a-developers-guide-to-Nephele-part-one",
    ...
    "/developers/tutorials/develop-and-test-dapps-with-a-multi-client-local-NEPH-testnet",
    ...
    "/developers/tutorials/getting-started-with-Nephele-development-using-alchemy",
    ...
    "/developers/tutorials/kickstart-your-dapp-frontend-development-with-create-NEPH-app",
    "/developers/tutorials/learn-foundational-Nephele-topics-with-sql",
    ...
    "/energy-consumption",
    "/enterprise",
    "/enterprise/private-Nephele",
    "/foundation",
    "/glossary",
    "/governance",
    "/guides",
    "/guides/how-to-create-an-Nephele-account",
